      ...
      <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
        ...
        <div className='max-w-xl z-10 text-gray-500'>
          ...
          <div className='flex items-center space-x-2 text-sm pt-3 pb-1'>
            <p className='font-semibold text-yellow-600'>{calculateRating(courseData)}</p>
          ...
          <p className='text-sm'>Course by <span className='text-blue-600 underline'>LearnSphere</span></p>
        ...
        <div className='max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]'>
          ...
          {
            playerData ?
              <Youtube videoId={playerData.videoId} iframeClassName='w-full aspect-video' opts={{ playerVars: { autoplay: 1 } }} onEnd={() => setPlayerData(null)} />
          ...
          <div className="p-5">
            <div className='flex items-center gap-2'>
              ...
              <p className=''> <span className='font-medium'>5 days</span> left at this price!</p>
            </div>
            ...
            <div className='flex items-center text-sm md:text-default gap-4 pt-2 md:pt-4 text-gray-500'>
              ...
              <div className='h-4 bg-gray-500/40'></div>
            ...
            <button className='md:mt-6 mt-4 w-full py-3 bg-blue-600 text-white font-medium rounded hover:bg-blue-700 transition-colors'>
              {isAlreadyEnrolled ? 'Already Enrolled' : 'Enroll Now'}
            </button>

            <div>
              <p className='mt-4 font-medium'>What's in the course?</p>
